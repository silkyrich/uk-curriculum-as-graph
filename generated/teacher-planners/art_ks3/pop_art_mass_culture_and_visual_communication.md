# Art and Design | Teacher Planner: Pop Art: Mass Culture and Visual Communication
*[TS-AD-KS3-002]*

**Subject:** Art and Design | **Key Stage:** KS3 | **Year group:** Y7, Y8
**Statutory reference:** about the history of art, craft, design and architecture, including periods, styles and major movements from ancient times to the present day | **Source document:** Art and Design (KS3) - National Curriculum Programme of Study
**Estimated duration:** 8 lessons | **Study type:** Artist Study | **Status:** Convention
...
**Why this lens fits:** Technical proficiency is the capacity to control how a medium's physical structure (pigment behaviour, layering, mark-making) serves expressive function; developing a personal voice requires intentional deployment of these structural choices to communicate specific meanings.
...
**Secondary lens:** Perspective and Interpretation — A 'personal creative voice' is an interpretive position — it requires pupils to develop and sustain their own viewpoint rather than imitate conventions, demanding self-aware interpretive decision-making throughout extended studio work.
...
**Artist:** Andy Warhol / Roy Lichtenstein (1928-1987 / 1923-1997)
**Art movement:** Pop Art
**Medium:** print, paint
**Techniques:** screen printing, lino printing, bold colour application, Ben-Day dots, image transfer
**Visual elements:** colour, line, pattern, shape
**Cultural context:** American/British
...
1. Copying Warhol prints without understanding the conceptual challenge Pop Art posed -- discuss why everyday objects were provocative as art
2. Using too many colours in screen prints -- limit to 3-4 bold colours for impact
3. Treating it as 'easy art' -- the apparent simplicity of Pop Art disguises sophisticated compositional and colour decisions
...
| repetition | |
| consumer culture | |
| Baroque | *(from concept key vocabulary)* |
| Expressionism | *(from concept key vocabulary)* |
| Impressionism | *(from concept key vocabulary)* |
| Modernism | *(from concept key vocabulary)* |
| Postmodernism | *(from concept key vocabulary)* |
| Renaissance | *(from concept key vocabulary)* |
| Romanticism | *(from concept key vocabulary)* |
| analyse | *(from concept key vocabulary)* |
| application | *(from concept key vocabulary)* |
| avant-garde | *(from concept key vocabulary)* |
...
- **Art History: Periods, Styles and Movements**: Understands how movements respond to historical, social and political contexts, makes connections across periods and cultures, and uses art historical knowledge to inform their own creative practice.
...
**Concept IDs:**
- `AD-KS3-C003`: Art History: Periods, Styles and Movements (primary)
- `AD-KS3-C001`: Advanced Technical Proficiency
