# Art and Design | Teacher Planner: Graphic Design and Typography
*[TS-AD-KS3-007]*

**Subject:** Art and Design | **Key Stage:** KS3 | **Year group:** Y8, Y9
...
**Estimated duration:** 7 lessons | **Study type:** Skill Building | **Status:** Convention
...
**Secondary lens:** Continuity and Change Over Time — The explicit sweep 'from ancient times to present' makes change over time the organising framework — pupils must understand how styles, movements and ideas develop, react against predecessors and persist or transform across centuries.
...
**Art movement:** Bauhaus / Contemporary Design
**Medium:** drawing, digital
**Techniques:** hand lettering, typographic layout, digital design, logo development, colour theory for communication
**Visual elements:** line, shape, colour, space
**Cultural context:** German/International
...
1. Using too many fonts -- limit to 2 maximum per design to teach typographic discipline
2. Ignoring hierarchy -- teach pupils that the viewer's eye must be guided through the design in a specific order
3. Digital-only work -- start with hand-drawn lettering and manual layouts before moving to software
...
| control | *(from concept key vocabulary)* |
...
**Node type:** `ArtTopicSuggestion` | **Study ID:** `TS-AD-KS3-007`
