# English | Teacher Planner: A Christmas Carol: Redemption and Social Responsibility
*[EU-ELT-KS4-003]*

**Subject:** English | **Key Stage:** KS4 | **Year group:** Y10, Y11
**Statutory reference:** GCSE English Literature: 19th-century novel (AO1, AO2, AO3, AO4) | **Source document:** English Literature (KS4) - National Curriculum Programme of Study
...
**Why this lens fits:** Victorian social and historical context is the perspectival framework within which 19th-century texts must be read — understanding the values and assumptions of the period allows pupils to interpret why characters, narrators and authors take the positions they do.
...
**Secondary lens:** Continuity and Change Over Time — Victorian genre and social context situate the text within a specific historical moment — pupils must understand what was distinctive about that moment (industrialisation, class, gender) and how those conditions shaped the literary forms that emerged.
...
1. Treating the novella as a simple moral tale rather than analysing Dickens' deliberate structural and linguistic choices
2. Context about Victorian poverty presented generically without linking it to specific textual moments
3. Over-reliance on the opening and closing staves, neglecting analysis of the Ghost visits
...
| Victorian | |
| philanthropy | |
| Empire | *(from concept key vocabulary)* |
| Gothic | *(from concept key vocabulary)* |
| Gothic anxiety | *(from concept key vocabulary)* |
| action | *(from concept key vocabulary)* |
| analytical | *(from concept key vocabulary)* |
| antagonist | *(from concept key vocabulary)* |
| argument | *(from concept key vocabulary)* |
| atmosphere | *(from concept key vocabulary)* |
| bildungsroman | *(from concept key vocabulary)* |
| character development | *(from concept key vocabulary)* |
...
|----------------------|-------------|-------------|
| Victorian Social and Historical Context | Victorian Narrative Fiction — Genre and Form | The social, economic and historical conditions of the Victorian era that shape 19th-century liter... |
| Characterisation and Narrative Voice | Victorian Narrative Fiction — Genre and Form | How writers construct character through multiple techniques: physical description, dialogue, acti... |
| Whole-Text Knowledge and Quotation Retention | Victorian Narrative Fiction — Genre and Form | The ability to demonstrate detailed knowledge of a complete literary text — novel, play or poetry... |
| Pre-1914 literature | Victorian Narrative Fiction — Genre and Form | Engaging with literary texts written before 1914 to understand historical literary traditions |
...
| Plot structure analysis | Victorian Narrative Fiction — Genre and Form | Understanding narrative structure (exposition, rising action, climax, resolution) and its effects |
| Characterisation analysis | Victorian Narrative Fiction — Genre and Form | Analyzing how characters are developed through description, dialogue, actions, and relationships |
...
**Node type:** `EnglishUnit` | **Study ID:** `EU-ELT-KS4-003`
