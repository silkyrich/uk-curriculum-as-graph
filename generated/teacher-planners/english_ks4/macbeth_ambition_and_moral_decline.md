# English | Teacher Planner: Macbeth: Ambition and Moral Decline
*[EU-ELT-KS4-001]*

**Subject:** English | **Key Stage:** KS4 | **Year group:** Y10, Y11
**Statutory reference:** GCSE English Literature: Shakespeare (AO1, AO2, AO3, AO4) | **Source document:** English Literature (KS4) - National Curriculum Programme of Study
...
**Still thin/missing:** Vocabulary definitions, Success criteria, Assessment alignment
...
**Why this lens fits:** Shakespearean dramatic conventions (blank verse, soliloquy, aside, dramatic irony) and language analysis are structure-function skills — pupils explain how specific structural features of Shakespeare's craft create dramatic and thematic effects on an audience.
...
**Secondary lens:** Perspective and Interpretation — Staging interpretation requires pupils to understand that a play script is a set of perspectival choices — different productions construct different readings of the same text, and analysing stagecraft means asking whose interpretation is being expressed.
...
**Text type:** Drama
**Features to teach:** soliloquy as a window into character's internal conflict, blank verse versus prose as indicator of status and mental state, dramatic irony and audience complicity, structural arc of rise and fall (tragic trajectory)

**Writing outcome:** Write an analytical essay (600-800 words) exploring how Shakespeare presents the theme of ambition in Macbeth, using quotations and contextual knowledge to support a sustained critical argument

**Literary terms:** soliloquy, blank verse, iambic pentameter, dramatic irony, hamartia, hubris, catharsis, tragic hero, aside, motif
...
**Leads to:** Macbeth: Guilt and the Supernatural

---

## Pitfalls to avoid

1. Students retell plot rather than analysing how Shakespeare creates effects
2. Context (AO3) bolted on as a paragraph rather than integrated into analysis
3. Quotations presented without analysis of specific word choices (AO2)
4. Writing about what Macbeth thinks rather than how Shakespeare constructs the character
...
|------|---------|------------|----------|
| Development of Church, State and Society 1509-1745 | History | Jacobean England, divine right of kings, the Gunpowder Plot | Strong |
...
| hubris | |
| catharsis | |
| Divine Right of Kings | *(from concept key vocabulary)* |
| Elizabethan | *(from concept key vocabulary)* |
| Great Chain of Being | *(from concept key vocabulary)* |
| Jacobean | *(from concept key vocabulary)* |
| alliteration | *(from concept key vocabulary)* |
| analytical | *(from concept key vocabulary)* |
| antagonist | *(from concept key vocabulary)* |
| antithesis | *(from concept key vocabulary)* |
| apostrophe | *(from concept key vocabulary)* |
| archaism | *(from concept key vocabulary)* |
...
|----------------------|-------------|-------------|
| Elizabethan and Jacobean Context | Shakespearean Language Analysis | The social, political, religious and theatrical contexts that shaped Shakespeare's plays: the Eli... |
...
| Whole-Text Knowledge and Quotation Retention | Shakespearean Dramatic Conventions | The ability to demonstrate detailed knowledge of a complete literary text — novel, play or poetry... |
...
| Shakespeare study | Shakespearean Dramatic Conventions | Studying two Shakespeare plays to understand Early Modern drama, language, and themes |
...
**Node type:** `EnglishUnit` | **Study ID:** `EU-ELT-KS4-001`
...
**Cypher query:**
```cypher
MATCH (ts:EnglishUnit {unit_id: 'EU-ELT-KS4-001'})
