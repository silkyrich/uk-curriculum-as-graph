# History | Teacher Planner: An Islamic Civilisation (e.g. Mughal India or Ottoman Empire)
*[HS-KS3-009]*

**Subject:** History | **Key Stage:** KS3 | **Year group:** Y7, Y8, Y9
**Statutory reference:** NC KS3 History: Schools must study at least one Islamic civilisation. Named exemplar: Mughal India 1526-1857. | **Source document:** History (KS3) - National Curriculum Programme of Study
...
1. What made the chosen Islamic civilisation powerful and significant?
2. How did the chosen civilisation manage religious and cultural diversity?
3. How was the chosen civilisation connected to European and British history?
...
**Why this lens fits:** The Holocaust requires pupils to trace a causal sequence from the conditions that enabled Nazi ideology to take hold, through the escalating persecution, to systematic genocide — and to evaluate the role of individual choices, institutional failures and international inaction in enabling each step.
...
**Secondary lens:** Evidence and Argument — Constructing extended written responses that use second-order concepts to answer historical questions with a structured, evidenced thesis is the most direct application of evidence_argument reasoning in the curriculum — pupils must move from source handling to analytical claim-making in a sustained piece of writing.

---

## Session structure: Topic Study + Comparison Study
...
|---------|-------------|-------------------|
| Similarity and Difference | How was this similar to or different from other times, places, or peoples? | At KS3, compare the chosen Islamic empire with contemporary European states: governance, culture, religious diversity, territorial extent. |
| Cause and Consequence | Why did this happen, and what were the effects? | At KS3, analyse the causes of the empire's rise and decline, and its consequences for the modern world. |
| Significance | Why does this matter, and to whom? | At KS3, evaluate the lasting significance of the empire's cultural, architectural and intellectual achievements. |
| Evidence and Interpretation | How do we know about this, and how do historians disagree? | At KS3, work with Mughal/Ottoman sources and critically evaluate European traveller accounts. |

---

## Key figures and events

**Key figures:** Akbar the Great, Shah Jahan, Suleiman the Magnificent

**Key events:**
- Founding of Ottoman Empire c.1299
- Fall of Constantinople 1453
- Mughal Empire founded 1526
- Reign of Akbar 1556-1605
- Building of Taj Mahal 1632-53

**Period:** c.1300 - 1857 (varies by chosen civilisation)

**Perspectives to include:** Mughal/Ottoman ruler, religious leader, artist/craftsman, European traveller, subject peoples

**Significance claim:** Islamic empires such as the Mughal and Ottoman created some of the most sophisticated political, cultural and architectural achievements in world history, demonstrating the global reach and diversity of Islamic civilisation.

**Historiographical debate:**
- Whether Akbar's religious tolerance represented genuine pluralism or pragmatic political management is debated
- The causes of Mughal decline are contested: was it internal weakness, British aggression, or a combination?
...
1. Presenting Islamic civilisations as monolithic rather than showing their internal diversity
2. Studying Mughal India solely as a prelude to British colonisation rather than on its own terms
3. Projecting modern geopolitical tensions onto historical Islamic civilisations

## Sensitive content

- Be sensitive to Muslim pupils and pupils from South Asian or Middle Eastern heritage backgrounds
- Avoid framing Islamic civilisations through the lens of European superiority
- Religious conflict within and between empires should be discussed with nuance and sensitivity
...
|------|---------|------------|----------|
| Middle East: Place Depth Study | Geography | The extent and diversity of Islamic empires; trade routes and urban centres | Moderate |
...
| tolerance | |
| diversity | |
| Magna Carta | *(from concept key vocabulary)* |
...
| colonialism | *(from concept key vocabulary)* |
| colony | *(from concept key vocabulary)* |
...
- **Constructing Historical Arguments**: Can construct a sustained historical argument with a clear thesis, deploying selected evidence to support the argument and addressing counter-evidence or alternative interpretations.

---

## Graph context

**Node type:** `HistoryStudy` | **Study ID:** `HS-KS3-009`

**Concept IDs:**
- `HI-KS3-C004`: Constructing Historical Arguments (primary)
- `HI-KS3-C001`: Power, Monarchy and Democracy
- `HI-KS3-C002`: Empire, Colonialism and its Consequences

**Cypher query:**
```cypher
MATCH (ts:HistoryStudy {study_id: 'HS-KS3-009'})
