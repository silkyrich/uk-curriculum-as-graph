# Design and Technology | Teacher Planner: Savoury Pasta Bake
*[TS-DT-KS2-008]*

**Subject:** Design and Technology | **Key Stage:** KS2 | **Year group:** Y5, Y6
**Statutory reference:** prepare and cook a variety of predominantly savoury dishes using a range of cooking techniques | **Source document:** Design and Technology (KS1/KS2) - National Curriculum Programme of Study
...
**Key vocabulary:** technique, cook, prepare, ingredient, chop, mix, boil, bake, fry, steam, blend, season, hygiene, safety, nutrition, recipe

**Common misconceptions:** Pupils may think that only baking counts as cooking, missing the wide range of cooking methods available. Broadening experience across different techniques challenges this assumption. Food hygiene may seem less interesting than cooking itself; making clear connections between specific hygiene practices and specific risks (cross-contamination, bacteria growth) makes the rationale concrete.
...
**Why this lens fits:** Cooking techniques work through specific physical and chemical transformations — heat causes proteins to denature, acid causes pastry to become flaky — and pupils must understand these causal processes to select and apply techniques correctly.
...
**Secondary lens:** Systems and System Models — Seasonality and sourcing requires pupils to model the food supply system: understanding how growing season, geography and supply chain decisions determine ingredient availability and quality positions food choices within a larger system.
...
**Design brief:** Design and cook a balanced pasta bake for four people. It must contain at least two vegetables and be predominantly savoury. Plan the recipe, prepare the ingredients, and cook the dish.

**Materials:** pasta, tinned tomatoes, vegetables (onion, pepper, courgette, mushroom), cheese, herbs (basil, oregano), garlic, oil
**Tools:** saucepans, baking dish, hob (adult supervised), oven (adult use), chopping boards, knives, grater, colander
**Techniques:** boiling pasta, frying vegetables, making sauce, assembling layers, grating cheese, baking
**Safety notes:** Hob and oven use with direct adult supervision. Demonstrate safe knife skills for chopping vegetables. Hot liquid (boiling water, hot sauce): adults to carry. Graters are sharp -- demonstrate safe grating technique with hand position. Check for dairy and gluten allergies.

**Evaluation criteria:**
- Does it contain at least two vegetables?
- Is the pasta properly cooked?
- Is the dish well-seasoned?
- Would you make this again at home?
**Food allergens:** gluten (pasta), dairy (cheese)
**Food skills:** boiling, frying, chopping, grating, assembling, baking, seasoning
...
1. Pasta overcooked before baking -- cook to al dente, it will soften further in the oven
2. Sauce too thin -- reduce before adding to pasta
3. Cheese not grated finely enough -- demonstrates poorly in the oven; pre-grate or supervise grating closely
...
|------|---------|------------|----------|
| European Regional Study | Geography | Italian food culture, pasta origins | Moderate |
| States of Matter and the Water Cycle | Science | States of matter: solid cheese melts, liquid sauce thickens | Moderate |
...
| nutritious | |
| balanced meal | |
| blend | *(from concept key vocabulary)* |
| catch | *(from concept key vocabulary)* |
| chop | *(from concept key vocabulary)* |
| cook | *(from concept key vocabulary)* |
| food miles | *(from concept key vocabulary)* |
| fresh | *(from concept key vocabulary)* |
| grow | *(from concept key vocabulary)* |
| harvest | *(from concept key vocabulary)* |
| hygiene | *(from concept key vocabulary)* |
| imported | *(from concept key vocabulary)* |
...
- **Cooking Techniques and Food Preparation**: Planning and cooking a dish as part of the design-make-evaluate cycle: researching, adapting a recipe, cooking it, and evaluating the result against criteria.

---

## Graph context

**Node type:** `DTTopicSuggestion` | **Study ID:** `TS-DT-KS2-008`

**Concept IDs:**
- `DT-KS2-C010`: Cooking Techniques and Food Preparation (primary)
- `DT-KS2-C011`: Seasonality and Ingredient Sourcing

**Cypher query:**
```cypher
MATCH (ts:DTTopicSuggestion {suggestion_id: 'TS-DT-KS2-008'})
