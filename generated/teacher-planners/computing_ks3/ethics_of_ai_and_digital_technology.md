# Computing | Teacher Planner: Ethics of AI and Digital Technology
*[TS-CO-KS3-008]*

**Subject:** Computing | **Key Stage:** KS3 | **Year group:** Y9
**Statutory reference:** understand a range of ways to use technology safely, respectfully, responsibly and securely | **Source document:** Computing (KS3/KS4) - National Curriculum Programme of Study
...
**Computational concepts:** digital literacy, algorithm
**Abstraction level:** Visual
**Themes:** AI ethics, digital citizenship, algorithmic bias, privacy
...
1. Presenting AI as either utopia or dystopia -- teach nuanced evaluation of trade-offs
2. Not grounding discussion in technical understanding -- pupils must understand how the technology works before debating its ethics
3. Discussion without structure -- use ethical frameworks (utilitarian, deontological, virtue ethics) at an accessible level
...
|------|---------|------------|----------|
| Persuasive and Argumentative Writing | English | Persuasive and argumentative writing on technology ethics | Moderate |
| Human Rights: What Are They and Why Do They Matter? | General | Human rights, digital rights, surveillance and democracy | Strong |
...
| responsibility | *(from concept key vocabulary)* |
| right | *(from concept key vocabulary)* |
| transparency | *(from concept key vocabulary)* |
...
**Node type:** `ComputingTopicSuggestion` | **Study ID:** `TS-CO-KS3-008`
...
**Cypher query:**
```cypher
MATCH (ts:ComputingTopicSuggestion {suggestion_id: 'TS-CO-KS3-008'})
