# Computing | Teacher Planner: Python Programming: Fundamentals
*[TS-CO-KS3-001]*

**Subject:** Computing | **Key Stage:** KS3 | **Year group:** Y7, Y8
**Statutory reference:** use 2 or more programming languages, at least one of which is textual, to solve a variety of computational problems | **Source document:** Computing (KS3/KS4) - National Curriculum Programme of Study
**Estimated duration:** 12 lessons | **Status:** Convention
...
**Computational concepts:** sequence, selection, repetition, variable, function
**Abstraction level:** Symbolic
**Themes:** text-based programming, Python, computational thinking
...
1. Indentation errors causing frustration -- teach that Python uses indentation as syntax, not decoration
2. Students copy-pasting code without understanding -- require line-by-line annotation of every program
3. Moving too fast from block-based thinking -- allow time for the cognitive shift to text-based programming
...
**Node type:** `ComputingTopicSuggestion` | **Study ID:** `TS-CO-KS3-001`
...
**Cypher query:**
```cypher
MATCH (ts:ComputingTopicSuggestion {suggestion_id: 'TS-CO-KS3-001'})
