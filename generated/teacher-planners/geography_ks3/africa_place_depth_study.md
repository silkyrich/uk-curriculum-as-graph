# Geography | Teacher Planner: Africa: Place Depth Study
*[GS-GE-KS3-007]*

**Subject:** Geography | **Key Stage:** KS3 | **Year group:** Y7, Y8, Y9
**Statutory reference:** NC KS3 Geography: 'understand geographical similarities, differences and links between places through the study of human and physical geography of a region within Africa' | **Source document:** Geography (KS3) - National Curriculum Programme of Study
**Estimated duration:** 10 lessons | **Study type:** Place Study | **Status:** Mandatory

**Planner coverage:** 10/12 expected capabilities surfaced

**Available now:** Curriculum anchor, Concept model, Differentiation data, Thinking lens, Lesson structure, Subject references, Cross-curricular links, Success criteria, Prior knowledge links, Learner scaffolding
**Still thin/missing:** Vocabulary definitions, Assessment alignment

---

## Enquiry questions

1. Is Africa really what the media says it is?
...
**Key vocabulary:** Africa, Asia, Russia, Middle East, region, environmental region, desert, savannah, tundra, tropical, continent, country, capital, megacity, political map, physical map, distribution, characteristics
...
**Why this lens fits:** Building fluent locational knowledge of major world regions involves recognising the spatial patterns of political boundaries, physical features and population distribution — not just memorising names but understanding why countries, cities and landscapes are distributed as they are.
...
**Map types:** choropleth, thematic map, population density, dot map
**Data sources:** African Development Bank, World Bank, UN Population Division

**Assessment guidance:** Can pupils challenge stereotypes about Africa using specific evidence from diverse countries? Can they explain the physical geography that shapes different African environments? Can they analyse development patterns across the continent?
...
**Development context:** not_applicable
**Key physical features:** Sahara Desert, Great Rift Valley, Nile, Congo Basin, Kilimanjaro, Sahel
**Key human features:** 54 countries, 1.4 billion population, fastest-growing middle class globally, 30% of world's mineral resources

### Republic of Kenya (Kenya, Africa, country, national)
**Development context:** LIC
**Key physical features:** Great Rift Valley, Mount Kenya, savanna grassland, Lake Victoria
**Key human features:** 55 million population, Nairobi, safari tourism, tea and coffee exports, mobile money (M-Pesa)

### Kingdom of Morocco (Morocco, Africa, country, national)
**Development context:** LIC
**Key physical features:** Atlas Mountains, Sahara Desert edge, Mediterranean coast, Atlantic coast
**Key human features:** 37 million population, Casablanca, Marrakech tourism, phosphate mining, renewable energy investment

### Republic of South Africa (South Africa, Africa, country, national)
**Development context:** NEE
**Key physical features:** Drakensberg Mountains, Kruger National Park, Table Mountain, two oceans coastline
**Key human features:** 60 million population, Johannesburg, Cape Town, mining economy, post-apartheid democracy

### Federal Democratic Republic of Ethiopia (Ethiopia, Africa, country, national)
**Development context:** LIC
**Key physical features:** Ethiopian Highlands, Great Rift Valley, Blue Nile source, Danakil Depression
**Key human features:** 120 million population, Addis Ababa (AU headquarters), ancient civilisation, coffee origin, rapid economic growth
...
1. Treating Africa as a single country or undifferentiated region rather than a continent of 54 diverse nations
2. Relying on stereotypical 'poverty and wildlife' imagery that ignores urbanisation, technology, and cultural richness
3. Failing to include African voices and perspectives — use sources from within African countries, not only external accounts

## Sensitive content

- Colonial legacy and its ongoing effects — discuss factually and sensitively
- Avoid 'white saviour' narratives when discussing aid and development
- Pupils of African heritage may have strong personal connections — create space for their knowledge
...
**Pupils can:**
- Challenge at least 2 common stereotypes about Africa with evidence
- Describe the physical geography of at least 2 contrasting African environments
- Explain factors affecting development in specific African countries
- Use data to compare development indicators across African nations
...
|------|---------|------------|----------|
| Ideas, Power, Industry and Empire 1745-1901 | History | Pre-colonial African kingdoms, colonialism, and independence movements | Strong |
| Ecosystem Relationships and Fieldwork | Science | Rift Valley tectonics and biodiversity of African ecosystems | Moderate |
...
- **Using compass directions and locational language** — Applying the four cardinal compass directions (North, South, East, West) and everyday directional language such as near, far, left and right to describe the location of features and routes on maps and in the environment.
...
- **Simple fieldwork and observational skills** — Going out into the school grounds and immediate surrounding environment to observe, describe and record human and physical geographical features at first hand, practising the habits of direct geographical enquiry.
...
| desertification | |
| neo-colonialism | |
| Africa | *(from concept key vocabulary)* |
| Asia | *(from concept key vocabulary)* |
| Middle East | *(from concept key vocabulary)* |
| Russia | *(from concept key vocabulary)* |
| capital | *(from concept key vocabulary)* |
| change | *(from concept key vocabulary)* |
| characteristics | *(from concept key vocabulary)* |
| comparison | *(from concept key vocabulary)* |
| connection | *(from concept key vocabulary)* |
| continent | *(from concept key vocabulary)* |
...
| World Regions: Africa, Asia and the Middle East | Place Depth Study: Africa and Asia | A detailed working knowledge of the world's major geographical regions, with KS3 focus extending ... |
...
**Node type:** `GeoStudy` | **Study ID:** `GS-GE-KS3-007`
...
**Cypher query:**
```cypher
MATCH (ts:GeoStudy {study_id: 'GS-GE-KS3-007'})
