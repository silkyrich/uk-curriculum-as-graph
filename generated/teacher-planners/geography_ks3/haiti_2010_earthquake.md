# Geography | Teacher Planner: Haiti 2010 Earthquake
*[GS-GE-KS3-001]*

**Subject:** Geography | **Key Stage:** KS3 | **Year group:** Y7, Y8
**Statutory reference:** NC KS3 Geography: 'understand, through the use of detailed place-based exemplars at a variety of scales, the key processes in physical geography relating to: geological timescales and plate tectonics' | **Source document:** Geography (KS3) - National Curriculum Programme of Study
**Estimated duration:** 5 lessons | **Study type:** Case Study | **Status:** Exemplar

**Planner coverage:** 9/12 expected capabilities surfaced

**Available now:** Curriculum anchor, Concept model, Differentiation data, Thinking lens, Lesson structure, Subject references, Success criteria, Prior knowledge links, Learner scaffolding
**Still thin/missing:** Cross-curricular links, Vocabulary definitions, Assessment alignment

---

## Enquiry questions

1. Why did so many people die in the Haiti earthquake?
...
**Key vocabulary:** plate tectonics, lithosphere, mantle, convection, boundary, convergent, divergent, transform, earthquake, volcano, subduction, mountain, ridge, trench, geological timescale

**Common misconceptions:** Pupils often think plate movement is fast enough to observe directly. Establishing that continental drift occurs at rates measured in centimetres per year over millions of years develops appropriate scale of time. The mechanism of plate movement (convection currents) is frequently confused with the plates themselves; keeping the two clearly distinct prevents conceptual muddle. The relationship between plate boundaries and the locations of earthquakes and volcanoes needs to be established empirically through map work as well as theoretically.
...
**Why this lens fits:** Plate tectonics is an Earth system process — the movement of tectonic plates drives volcanic activity, earthquakes, mountain building and ocean formation through interlocking physical mechanisms operating over geological time, requiring pupils to model a large-scale physical system.
...
**Secondary lens:** Stability and Change — The tectonic framework explains both the stability of plate interiors and the instability at plate boundaries where hazards occur; pupils must understand why some regions are geologically stable while others experience frequent catastrophic change.
...
**Map types:** hazard overlay, gis, population density, choropleth
**Data sources:** USGS, World Bank, UN OCHA, Red Cross

**Assessment guidance:** Can pupils explain the tectonic CAUSE of the earthquake and why Haiti was particularly VULNERABLE (linking physical and human factors)? Can they evaluate the effectiveness of international response using data? Can they compare Haiti's experience with a contrasting HIC case study?

---

## Locations

### Port-au-Prince (Haiti, North_America, city, national)
**Development context:** LIC
**Key physical features:** Caribbean plate boundary, deforested hillsides, coastal plain
**Key human features:** 2 million population, informal settlements, limited infrastructure, NGO presence
...
**Compare through:** development level, governance quality, preparedness infrastructure, casualty toll relative to magnitude, cascading effects, international response
**Stimulus questions:**
...
1. Reducing Haiti to a simple 'poor country = more deaths' narrative without analysing the structural causes of vulnerability (colonial debt, deforestation, governance)
2. Treating the earthquake as a one-off event rather than connecting it to ongoing tectonic risk and recovery challenges
3. Using outdated or sensationalised imagery that stereotypes Haitian people rather than showing resilience and agency

## Sensitive content

- Significant loss of life (230,000+ deaths) — handle with sensitivity, avoid graphic imagery
- Poverty and development inequality — avoid deficit framing of Haitian people
...
**Pupils can:**
- Explain the tectonic cause of the Haiti earthquake
- Analyse why Haiti was particularly vulnerable (physical + human factors)
- Evaluate the effectiveness of international aid using data
- Compare impacts and responses with a contrasting HIC earthquake
...
| HDI | |
| aid dependency | |
| GDP | *(from concept key vocabulary)* |
| adaptation | *(from concept key vocabulary)* |
| aid | *(from concept key vocabulary)* |
| boundary | *(from concept key vocabulary)* |
| carbon dioxide | *(from concept key vocabulary)* |
| climate change | *(from concept key vocabulary)* |
| colonialism | *(from concept key vocabulary)* |
| convection | *(from concept key vocabulary)* |
| convergent | *(from concept key vocabulary)* |
| debt | *(from concept key vocabulary)* |
...
**Node type:** `GeoStudy` | **Study ID:** `GS-GE-KS3-001`
...
**Cypher query:**
```cypher
MATCH (ts:GeoStudy {study_id: 'GS-GE-KS3-001'})
