# Art and Design | Teacher Planner: Kandinsky Circles
*[TS-AD-KS1-007]*

**Subject:** Art and Design | **Key Stage:** KS1 | **Year group:** Y1, Y2
**Statutory reference:** to develop a wide range of art and design techniques in using colour | **Source document:** Art and Design (KS1/KS2) - National Curriculum Programme of Study
**Estimated duration:** 3 lessons | **Study type:** Artist Study | **Status:** Convention
...
**Medium:** paint
**Techniques:** colour mixing, wet-on-wet, concentric painting
**Visual elements:** colour, shape, pattern
**Cultural context:** Russian/European
...
1. Pupils try to make perfect circles -- emphasise that Kandinsky's circles are deliberately imperfect
2. All squares look the same -- challenge pupils to use different colour combinations in each
3. Using only primary colours -- this is the time to explore the full range of mixing
...
| composition | |
| circle | |
| architect | *(from concept key vocabulary)* |
| artist | *(from concept key vocabulary)* |
| blend | *(from concept key vocabulary)* |
| brush | *(from concept key vocabulary)* |
| colour | *(from concept key vocabulary)* |
| craft maker | *(from concept key vocabulary)* |
| culture | *(from concept key vocabulary)* |
| curved | *(from concept key vocabulary)* |
| designer | *(from concept key vocabulary)* |
| drawing | *(from concept key vocabulary)* |
...
**Node type:** `ArtTopicSuggestion` | **Study ID:** `TS-AD-KS1-007`
