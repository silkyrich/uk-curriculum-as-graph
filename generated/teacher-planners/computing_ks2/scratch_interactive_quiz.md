# Computing | Teacher Planner: Scratch Interactive Quiz
*[TS-CO-KS2-002]*

**Subject:** Computing | **Key Stage:** KS2 | **Year group:** Y4, Y5
...
**Computational concepts:** selection, variable, input output
**Abstraction level:** Visual
**Themes:** programming, selection, variables
...
1. Answer comparison is case-sensitive -- teach 'lowercase both' or accept multiple spellings
2. Score variable not initialised to 0 at the start -- teach reset at program start
3. Questions all asked at once without waiting for input -- teach the 'ask and wait' block
...
**Node type:** `ComputingTopicSuggestion` | **Study ID:** `TS-CO-KS2-002`
