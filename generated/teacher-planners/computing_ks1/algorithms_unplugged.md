# Computing | Teacher Planner: Algorithms Unplugged
*[TS-CO-KS1-001]*

**Subject:** Computing | **Key Stage:** KS1 | **Year group:** Y1
**Statutory reference:** understand what algorithms are; how they are implemented as programs on digital devices; and that programs execute by following precise and unambiguous instructions | **Source document:** Computing (KS1/KS2) - National Curriculum Programme of Study
...
**Themes:** algorithms, computational thinking
...
1. Instructions too vague -- 'put the jam on' could mean on the bread, on the table, or on your head
2. Skipping the physical activity -- pupils need to actually follow each other's algorithms to feel the errors
3. Moving to screens too quickly -- unplugged understanding must be secure first
...
| input | *(from concept key vocabulary)* |
