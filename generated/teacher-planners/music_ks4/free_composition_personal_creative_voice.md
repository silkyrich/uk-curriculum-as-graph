# Music | Teacher Planner: Free Composition: Personal Creative Voice
*[TS-MU-KS4-003]*

**Subject:** Music | **Key Stage:** KS4 | **Year group:** Y10, Y11
**Statutory reference:** compose music that demonstrates understanding and creative use of the inter-related dimensions of music | **Source document:** Music (KS4) - National Curriculum Programme of Study
**Estimated duration:** 16 lessons | **Status:** Exemplar
...
**Why this lens fits:** Compositional Craft and Structure (C003) is the explicit application of structural principles — form, development, coherence — to original material; the GCSE submission requires pupils to demonstrate that their structural choices serve clear expressive and communicative functions.
...
**Musical elements:** melody, harmony, rhythm, structure, dynamics, texture
**Instruments:** keyboard, technology
**Notation level:** staff full
...
1. Starting composing without a plan -- require a structural outline before writing notes
2. Melody that lacks shape or phrase structure -- teach 4-bar and 8-bar phrase patterns with cadential goals
3. Composition too short or repetitive -- teach development techniques that extend ideas without merely repeating them
...
| bass clef | *(from concept key vocabulary)* |
| binary | *(from concept key vocabulary)* |
| chord symbol | *(from concept key vocabulary)* |
| countermelody | *(from concept key vocabulary)* |
| duration | *(from concept key vocabulary)* |
| dynamics | *(from concept key vocabulary)* |
| dynamics marking | *(from concept key vocabulary)* |
| harmony | *(from concept key vocabulary)* |
| homophony | *(from concept key vocabulary)* |
