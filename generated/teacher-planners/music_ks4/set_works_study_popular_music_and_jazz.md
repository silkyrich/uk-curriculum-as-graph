# Music | Teacher Planner: Set Works Study: Popular Music and Jazz
*[TS-MU-KS4-006]*

**Subject:** Music | **Key Stage:** KS4 | **Year group:** Y10, Y11
**Statutory reference:** demonstrate knowledge and understanding of the historical, cultural and social contexts of music from different periods and traditions | **Source document:** Music (KS4) - National Curriculum Programme of Study
**Estimated duration:** 14 lessons | **Status:** Exemplar
...
**Why this lens fits:** Musical Elements and Analytical Terminology provides the vocabulary for labelling and discussing musical patterns — recognising a sequence, an ostinato or a modulation requires both pattern perception and precise terminology to communicate the observation.
...
**Secondary lens:** Perspective and Interpretation — Set work study and stylistic awareness require pupils to construct interpretive readings of music from within specific historical and generic contexts — appraising demands understanding why a composer made particular choices given their context, not just identifying what they did.
...
**Genre:** Pop
**Musical elements:** rhythm, harmony, melody, texture, structure, timbre
**Notation level:** lead sheet
**Listening repertoire:** Killer Queen - Queen, Africa - Toto, Defying Gravity - from Wicked
...
1. Analysing popular music less rigorously than classical -- apply the same analytical framework to all genres
2. Ignoring the studio production dimension -- teach pupils to discuss recording techniques, mixing and production choices
3. Only studying the specific set works without broader genre knowledge -- build stylistic awareness through wider listening
...
| Romantic | *(from concept key vocabulary)* |
| baroque | *(from concept key vocabulary)* |
| classical | *(from concept key vocabulary)* |
| convention | *(from concept key vocabulary)* |
| duration | *(from concept key vocabulary)* |
...
| Musical Elements and Analytical Terminology | Music History: Periods, Styles and Set Works | The inter-related dimensions of music — pitch (melody, harmony, tonality), duration (rhythm, metr... |
...
**Node type:** `MusicTopicSuggestion` | **Study ID:** `TS-MU-KS4-006`
...
**Cypher query:**
```cypher
MATCH (ts:MusicTopicSuggestion {suggestion_id: 'TS-MU-KS4-006'})
