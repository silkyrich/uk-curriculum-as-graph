# History | Teacher Planner: The First Aeroplanes
*[HS-KS1-003]*

**Subject:** History | **Key Stage:** KS1 | **Year group:** Y1, Y2
**Statutory reference:** NC KS1 History: 'events beyond living memory that are significant nationally or globally [for example, the Great Fire of London, the first aeroplane flight or events commemorated through festivals or anniversaries]' | **Source document:** History (KS1/KS2) - National Curriculum Programme of Study
**Estimated duration:** 4 lessons | **Study type:** Event Study | **Status:** Exemplar
...
1. Why was the first aeroplane flight so significant?
2. How have aeroplanes changed since 1903?
3. What would the world be like without aeroplanes?
...
|---------|-------------|-------------------|
| Significance | Why does this matter, and to whom? | At KS1, significance means asking 'Why was this important?' and 'What difference did it make to people's lives?' |
| Change and Continuity | What changed, what stayed the same, and why? | At KS1, change means comparing 'before' and 'after' the invention: how was travel different before aeroplanes? |
| Chronology | When did this happen, and how does it fit into the wider timeline? | At KS1, place 1903 on a timeline and compare with other events studied. |

---

## Key figures and events

**Key figures:** Orville Wright, Wilbur Wright

**Key events:**
- Wright Brothers' first flight at Kitty Hawk 17 December 1903

**Period:** 1903

**Perspectives to include:** Orville Wright (pilot), Wilbur Wright (observer), spectator at Kitty Hawk

**Significance claim:** The Wright Brothers' first powered flight in 1903 was the beginning of aviation, which transformed global travel, warfare, trade and communication within a single century.
...
1. Focusing only on the Wright Brothers without acknowledging other aviation pioneers
2. Not helping pupils grasp how recently flight was invented relative to other historical events they study
...
|------|---------|------------|----------|
| Friction Investigation | Science | Forces: what makes an aeroplane fly? Lift, thrust, drag, gravity | Strong |
| Windmill | Design and Technology | Designing and testing paper aeroplanes; understanding design iteration | Strong |
...
| continuity | *(from concept key vocabulary)* |
| decade | *(from concept key vocabulary)* |
| develop | *(from concept key vocabulary)* |
...
|----------------------|-------------|-------------|
| Time and Chronology | Change and Continuity | Chronology is the ordering of events and periods in time. Understanding chronology requires both ... |
...
**Node type:** `HistoryStudy` | **Study ID:** `HS-KS1-003`
...
**Cypher query:**
```cypher
MATCH (ts:HistoryStudy {study_id: 'HS-KS1-003'})
