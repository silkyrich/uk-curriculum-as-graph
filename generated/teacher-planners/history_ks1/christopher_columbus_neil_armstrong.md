# History | Teacher Planner: Christopher Columbus & Neil Armstrong
*[HS-KS1-007]*

**Subject:** History | **Key Stage:** KS1 | **Year group:** Y1, Y2
**Statutory reference:** NC KS1 History: 'the lives of significant individuals in the past who have contributed to national and international achievements. Some should be used to compare aspects of life in different periods [for example, ... Christopher Columbus and Neil Armstrong...]' | **Source document:** History (KS1/KS2) - National Curriculum Programme of Study
...
1. What was the same about Columbus's and Armstrong's explorations?
2. How was exploring in 1492 different from exploring in 1969?
3. Who was more significant as an explorer, and why?
...
**Why this lens fits:** This cluster is the foundational introduction to the most central historical thinking concept — pupils build the vocabulary of time and begin to distinguish what has changed from what has persisted within living memory, which is the cognitive essence of continuity_change reasoning.
...
|---------|-------------|-------------------|
| Similarity and Difference | How was this similar to or different from other times, places, or peoples? | At KS1, compare two explorers from different times: what was the same about their journeys? What was different? |
| Chronology | When did this happen, and how does it fit into the wider timeline? | At KS1, understand the vast time gap between 1492 and 1969 using a simple timeline. |
| Significance | Why does this matter, and to whom? | At KS1, ask 'Why do we still remember these explorers?' and 'What difference did their journeys make?' |

---

## Key figures and events

**Key figures:** Christopher Columbus, Neil Armstrong
...
**Perspectives to include:** Columbus, Neil Armstrong, people already living in the Americas, TV viewer in 1969

**Significance claim:** Columbus's voyages connected the Old and New Worlds, beginning a process of globalisation with profound consequences. Armstrong's Moon landing represented humanity's first step beyond Earth. Together they frame the story of human exploration across five centuries.
...
1. Presenting Columbus as simply a heroic 'discoverer' without acknowledging the people already living in the Americas
2. Not using the comparison to develop genuine chronological thinking about the 500-year gap

## Sensitive content

- Columbus's arrival in the Americas led to colonisation, exploitation and the deaths of millions of indigenous people; at KS1, acknowledge that people already lived there and that the consequences were complex
- Avoid the word 'discovery' for Columbus: he arrived in a place where people already lived
...
|------|---------|------------|----------|
| World Continents and Oceans | Geography | Maps: where did Columbus and Armstrong go? How do we show journeys on maps? | Strong |
...
**Node type:** `HistoryStudy` | **Study ID:** `HS-KS1-007`
...
**Cypher query:**
```cypher
MATCH (ts:HistoryStudy {study_id: 'HS-KS1-007'})
