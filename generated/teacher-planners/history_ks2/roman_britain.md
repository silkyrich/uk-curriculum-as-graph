# History | Teacher Planner: Roman Britain
*[HS-KS2-002]*

**Subject:** History | **Key Stage:** KS2 | **Year group:** Y3, Y4
**Statutory reference:** NC KS2 History: 'The Roman Empire and its impact on Britain' | **Source document:** History (KS1/KS2) - National Curriculum Programme of Study
**Estimated duration:** 12 lessons | **Study type:** Period Study | **Status:** Mandatory

**Planner coverage:** 9/11 expected capabilities surfaced

**Available now:** Curriculum anchor, Concept model, Differentiation data, Thinking lens, Lesson structure, Subject references, Cross-curricular links, Prior knowledge links, Learner scaffolding
...
1. Why did the Romans invade Britain, and what were the consequences?
2. What can the Vindolanda tablets tell us about everyday life in Roman Britain?
3. How significant was the Roman legacy in modern Britain?
...
**Why this lens fits:** Each successive wave of change (Roman invasion, Anglo-Saxon migration, Viking raids, Norman Conquest) requires pupils to ask what caused it and what consequences followed, practising causal reasoning at an accessible narrative scale.
...
**Secondary lens:** Continuity and Change Over Time — The sweep from Stone Age to Norman Conquest is explicitly a study in long-run change and continuity — pupils must trace what shifted (tools, religion, political organisation, language) and what persisted across prehistoric, Roman and Anglo-Saxon periods, building a chronological framework for later study.

---

## Session structure: Topic Study + Source Enquiry

This study uses 2 vehicle templates:

### Topic Study (main structure)
...
### 1. Vindolanda Tablets (Primary Written, )
Thin wooden writing tablets discovered at the Roman fort of Vindolanda near Hadrian's Wall. Written in ink by Roman soldiers and their families, they record everyday life: military supplies, birthday party invitations, requests for warm socks. They are the oldest surviving handwritten documents in Britain.

**How to use:** Read a simplified Vindolanda tablet (e.g. the birthday invitation from Claudia Severa, or the request for warm socks). Ask: 'What does this tell us about daily life for a Roman soldier?' Then: 'These are personal letters. How is this different from an official Roman record? What can personal letters tell us that official records cannot?'

**Location:** Vindolanda Museum, Northumberland; British Museum, London
**URL:** https://www.vindolanda.com/roman-writing-tablets

### 2. Hadrian's Wall (Built Heritage, )
A stone wall built on the orders of Emperor Hadrian stretching 73 miles across northern England from Wallsend-on-Tyne to Bowness-on-Solway. It marked the northern frontier of the Roman Empire and contained forts, milecastles and turrets for military garrisons. Its construction demonstrates the scale of Roman engineering and military organisation.

**How to use:** Ask: 'Why did the Romans build a wall here? What does it tell us about the limits of Roman power?' and 'What can the wall tell us about how the Romans controlled their empire?' Use alongside HSRC-009 to build a picture of life on the Roman frontier.

**Location:** Northern England (English Heritage / National Trust)
**URL:** https://www.english-heritage.org.uk/visit/places/hadrians-wall/

### 3. Roman Coins from Britain (Primary Archaeological, )
Thousands of Roman coins have been found across Britain, from military sites, towns, villas and hoards. They carry portraits of emperors and symbols of Roman power. Their distribution across Britain maps the extent of Romanisation and trade networks.

**How to use:** Show a Roman coin with an emperor's portrait. Ask: 'What can this coin tell us about who was in charge?' and 'Where this coin was found tells us something too -- what might it mean that Roman coins were found in Scotland?' Coins are accessible primary sources for KS2: they are small, concrete objects with readable images.

**Location:** British Museum, London; local museums across Britain
**URL:** https://www.britishmuseum.org/collection/search?keyword=roman+coin+britain
...
|---------|-------------|-------------------|
| Cause and Consequence | Why did this happen, and what were the effects? | At KS2, identify multiple causes of the Roman invasion (trade, resources, prestige, military ambition) and rank them. Analyse both intended and unintended consequences of Romanisation. |
| Significance | Why does this matter, and to whom? | At KS2, evaluate the lasting significance of the Roman legacy using explicit criteria: roads, towns, language, law. |
| Evidence and Interpretation | How do we know about this, and how do historians disagree? | At KS2, use the Vindolanda tablets as primary sources: what can they tell us about daily life? What are their limitations? |
| Change and Continuity | What changed, what stayed the same, and why? | At KS2, identify what changed in Britain during Roman occupation and what persisted after withdrawal. |

---

## Key figures and events

**Key figures:** Boudicca, Julius Caesar, Claudius, Hadrian
...
**Perspectives to include:** Roman coloniser, Briton, Roman soldier, enslaved person

**Significance claim:** The Roman occupation fundamentally transformed Britain's infrastructure, culture and identity, leaving a legacy of roads, towns, language and law that shaped subsequent British history.
...
**Follows:** Stone Age to Iron Age Britain
**Leads to:** Anglo-Saxon and Scots Settlement

---

## Pitfalls to avoid

1. Presenting the Romans as unambiguously civilising rather than examining the violence and exploitation of conquest
2. Neglecting the perspective of the indigenous Britons and presenting history solely from the Roman viewpoint
3. Reducing Boudicca to a simple hero narrative without examining the complexity of her revolt and its consequences
...
|------|---------|------------|----------|
| UK Regional Study | Geography | Roman roads and settlement patterns | Moderate |
| Spelling and Vocabulary: Word Detective | English | Diary writing as a Roman soldier or Boudicca; Latin roots in English vocabulary | Strong |
| Bridges: Beam, Arch and Truss | Design and Technology | Roman building techniques: arches, aqueducts, mosaics | Strong |
...
| revolt | |
| empire | |
| Anglo-Saxon | *(from concept key vocabulary)* |
| Bronze Age | *(from concept key vocabulary)* |
| Iron Age | *(from concept key vocabulary)* |
| Norman | *(from concept key vocabulary)* |
| Roman | *(from concept key vocabulary)* |
| Stone Age | *(from concept key vocabulary)* |
| Viking | *(from concept key vocabulary)* |
...
**Node type:** `HistoryStudy` | **Study ID:** `HS-KS2-002`
...
**Cypher query:**
```cypher
MATCH (ts:HistoryStudy {study_id: 'HS-KS2-002'})
