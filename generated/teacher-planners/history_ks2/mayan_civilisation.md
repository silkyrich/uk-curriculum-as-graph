# History | Teacher Planner: Mayan Civilisation
*[HS-KS2-013]*

**Subject:** History | **Key Stage:** KS2 | **Year group:** Y5, Y6
**Statutory reference:** NC KS2 History: 'A non-European society that provides contrasts with British history' -- one of three named options | **Source document:** History (KS1/KS2) - National Curriculum Programme of Study
...
1. What was happening in Mayan civilisation at the same time as Anglo-Saxon England, and how do they compare?
2. What can Mayan buildings and inscriptions tell us about their society?
3. Why did the great Mayan cities decline, and what challenges do historians face in answering this?
...
|---------|-------------|-------------------|
| Similarity and Difference | How was this similar to or different from other times, places, or peoples? | At KS2, compare Mayan civilisation c.900 CE with Anglo-Saxon England at the same time using systematic criteria. |
| Significance | Why does this matter, and to whom? | At KS2, evaluate the significance of Mayan achievements (writing, mathematics, astronomy, architecture). |
| Evidence and Interpretation | How do we know about this, and how do historians disagree? | At KS2, use Mayan codices, inscriptions and architecture as evidence. Ask what these can and cannot tell us. |
| Cause and Consequence | Why did this happen, and what were the effects? | At KS2, examine the complex causes of Classic Maya political fragmentation. |

---

## Key figures and events

**Key figures:** K'inich Janaab Pakal (Pakal the Great), Lady Six Sky

**Key events:**
- Development of Mayan writing system
- Classic Period city-building c.250-900 CE
- Political fragmentation of Classic Maya c.900 CE
- Spanish contact and conquest 1500s

**Period:** c.2000 BC - 1500 AD (depth focus c.900 CE)

**Perspectives to include:** Mayan ruler, priest/astronomer, farmer, modern Maya descendant

**Significance claim:** The Maya independently developed writing, mathematics (including zero), sophisticated astronomy and monumental architecture, demonstrating that complex civilisation can emerge in radically different environments and cultural contexts.

**Historiographical debate:**
- The 'Classic Maya collapse' is no longer seen as sudden but as a complex process of political fragmentation driven by warfare, environmental stress and social change
- Debate continues over the extent to which Mayan city-states cooperated or competed with each other
...
1. Using the idea of 'mysterious collapse' rather than examining the complex factors behind Mayan political fragmentation
2. Treating Mayan civilisation as extinct rather than recognising that millions of Maya people live in Central America today
3. Sensationalising human sacrifice without contextualising it within Mayan religious beliefs and cosmology

## Sensitive content

- Human sacrifice was part of Mayan religious practice; discuss with sensitivity and cultural context
- Recognise that Maya people are a living community today, not a 'vanished' civilisation
- The Spanish conquest of Maya territory involved significant violence and cultural destruction
...
|------|---------|------------|----------|
| Americas Regional Study | Geography | Mayan city-states in the Central American rainforest; environmental factors | Moderate |
...
**Node type:** `HistoryStudy` | **Study ID:** `HS-KS2-013`
...
**Cypher query:**
```cypher
MATCH (ts:HistoryStudy {study_id: 'HS-KS2-013'})
