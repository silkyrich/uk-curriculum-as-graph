# Music | Teacher Planner: Samba Drumming: Brazilian Carnival
*[TS-MU-KS3-003]*
...
**Musical elements:** rhythm, pulse, texture, dynamics, timbre
**Instruments:** samba drums, percussion
**Notation level:** rhythm only
**Listening repertoire:** Olodum - Requebra, Samba de Janeiro - Bellini, Rio Carnival bateria recordings
...
1. Everyone playing at maximum volume -- teach dynamic control; samba has quiet grooves as well as full bateria
2. Parts drifting out of sync -- the surdo (bass drum) is the anchor; listen to it constantly
3. No breaks or variety -- learn standard samba breaks (chamada) to add structural interest
...
| ensemble | *(from concept key vocabulary)* |
...
**Node type:** `MusicTopicSuggestion` | **Study ID:** `TS-MU-KS3-003`
...
**Cypher query:**
```cypher
MATCH (ts:MusicTopicSuggestion {suggestion_id: 'TS-MU-KS3-003'})
