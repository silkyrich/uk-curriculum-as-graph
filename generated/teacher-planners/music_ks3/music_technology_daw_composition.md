# Music | Teacher Planner: Music Technology: DAW Composition
*[TS-MU-KS3-007]*

**Subject:** Music | **Key Stage:** KS3 | **Year group:** Y8, Y9
...
**Genre:** Electronic
**Musical elements:** timbre, texture, structure, rhythm, dynamics
**Instruments:** technology
**Notation level:** none
**Listening repertoire:** Giorgio by Moroder - Daft Punk, Scary Monsters and Nice Sprites - Skrillex, Kiasmos - Blurred
...
1. Assembling loops without understanding the musical decisions involved -- teach why certain loops work together (key, tempo, genre)
2. Pieces that loop endlessly without structural development -- require verse-chorus or A-B-A form
3. Over-reliance on pre-made loops -- require at least one originally composed MIDI track per piece
...
**Node type:** `MusicTopicSuggestion` | **Study ID:** `TS-MU-KS3-007`
...
**Cypher query:**
```cypher
MATCH (ts:MusicTopicSuggestion {suggestion_id: 'TS-MU-KS3-007'})
