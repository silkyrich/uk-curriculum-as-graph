# Music | Teacher Planner: Composing with Ostinato and Minimalism
*[TS-MU-KS3-004]*

**Subject:** Music | **Key Stage:** KS3 | **Year group:** Y8
**Statutory reference:** improvise and compose; and extend and develop musical ideas by drawing on a range of musical structures, styles, genres and traditions | **Source document:** Music (KS3) - National Curriculum Programme of Study
...
**Why this lens fits:** Compositional Techniques and Devices — ostinato, sequence, imitation, augmentation, diminution, structural forms — are explicitly structural concepts whose value is understood through how each shapes the function and effect of a musical passage.
...
**Secondary lens:** Perspective and Interpretation — Appraising world music and diverse cultural contexts requires pupils to suspend familiar Western conventions and listen from within unfamiliar aesthetic frameworks — the central cognitive demand is constructing and sustaining an interpretive position shaped by cultural knowledge.
...
**Composer/piece:** Steve Reich / Philip Glass — Clapping Music / Piano Phase
**Musical elements:** rhythm, texture, structure, timbre, dynamics
**Instruments:** keyboard, tuned percussion, untuned percussion
**Notation level:** graphic
**Listening repertoire:** Clapping Music - Steve Reich, In C - Terry Riley, Glassworks: Opening - Philip Glass
...
1. Pieces too repetitive without enough gradual change -- teach specific transformation techniques (note addition, phase shift)
2. All parts in the same register -- use different octaves and timbres to create textural interest
3. Not recording the composition -- use graphic or grid notation to capture the layering structure
...
| diminution | *(from concept key vocabulary)* |
| dynamics | *(from concept key vocabulary)* |
...
- **Compositional Techniques and Devices**: Composes with command of multiple devices, uses form deliberately (binary, ternary, rondo), and makes purposeful choices about texture, dynamics and instrumentation to achieve specific effects.
...
**Concept IDs:**
- `MU-KS3-C003`: Compositional Techniques and Devices (primary)
- `MU-KS3-C001`: Advanced Performance Skills
