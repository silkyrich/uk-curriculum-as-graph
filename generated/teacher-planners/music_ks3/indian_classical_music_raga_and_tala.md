# Music | Teacher Planner: Indian Classical Music: Raga and Tala
*[TS-MU-KS3-005]*

**Subject:** Music | **Key Stage:** KS3 | **Year group:** Y8
**Statutory reference:** listen with increasing discrimination to a wide range of music from great composers and musicians | **Source document:** Music (KS3) - National Curriculum Programme of Study
...
**Key vocabulary:** tradition, culture, genre, style, folk, classical, jazz, world music, percussion, melody, rhythm, call-and-response, heterophony, modal, pentatonic

**Common misconceptions:** Pupils may approach world music with an ethnocentric assumption that Western music is the norm and other traditions are exotic variants. Presenting diverse traditions as equally sophisticated and complete musical systems challenges this. Pupils may assume that complex music requires complex notation; world music often demonstrates that sophisticated musical understanding can be transmitted and developed entirely orally. The concept that music can serve different social functions in different cultures (religious, ceremonial, work-related) may challenge assumptions that music is primarily entertainment.
...
**Why this lens fits:** Appraising world music and diverse cultural contexts requires pupils to suspend familiar Western conventions and listen from within unfamiliar aesthetic frameworks — the central cognitive demand is constructing and sustaining an interpretive position shaped by cultural knowledge.
...
**Genre:** World Indian
**Composer/piece:** Ravi Shankar
**Musical elements:** melody, rhythm, timbre, texture, structure
**Instruments:** keyboard, tuned percussion
**Notation level:** none
**Listening repertoire:** Raga Jog - Ravi Shankar, Raga Yaman - various artists, Anoushka Shankar performances
...
1. Treating Indian music as exotic curiosity rather than sophisticated tradition -- emphasise that raga theory is as rigorous as Western harmony
2. Using Western instruments to replicate Indian sounds -- use sitar if available, otherwise keyboards in monophonic mode with drone
3. Only teaching North Indian (Hindustani) tradition -- acknowledge both North and South Indian (Carnatic) traditions
...
| jhala | |
| cycle | |
| call-and-response | *(from concept key vocabulary)* |
| chord | *(from concept key vocabulary)* |
| classical | *(from concept key vocabulary)* |
| consonance | *(from concept key vocabulary)* |
| culture | *(from concept key vocabulary)* |
| dissonance | *(from concept key vocabulary)* |
| dominant | *(from concept key vocabulary)* |
| folk | *(from concept key vocabulary)* |
| genre | *(from concept key vocabulary)* |
| harmony | *(from concept key vocabulary)* |
...
- **Musical Traditions and World Music**: Studies world music traditions in depth, connecting musical features to cultural context and function, and uses diverse musical traditions as creative resources in their own composition and performance.
...
**Concept IDs:**
- `MU-KS3-C004`: Musical Traditions and World Music (primary)
