...
| File | Description |
|---|---|
| `graph_model_v2.md` | Earlier graph model spec — superseded by `core/docs/graph_model_overview.md` |
...
- `learning-science/` — 16 papers on knowledge tracing, motivation, pedagogy, and ITS
