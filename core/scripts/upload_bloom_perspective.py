...
Usage:
  python3 core/scripts/upload_bloom_perspective.py
  python3 core/scripts/upload_bloom_perspective.py --perspective core/data/bloom/perspectives/comparison_perspective.json
"""
...
DEFAULT_PERSPECTIVE = Path(__file__).parent.parent / 'data' / 'bloom' / 'perspectives' / 'main_perspective.json'
